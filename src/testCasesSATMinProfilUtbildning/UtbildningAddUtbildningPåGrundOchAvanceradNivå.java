...
public class UtbildningAddUtbildningPåGrundOchAvanceradNivå extends BeforeAfterTestBrowsers {
	...
	public void UtbildningPåGrundOchAvanceradNivåAdd() {
		...
		driver.findElement(PortalLoggedInAsUserMinProfil.MinProfil_Utbildning_LäggTillUtbildningPåGrundOchAvanceradNivå()).click();
	}
	...
	public void ÅrFörExamen() {
		...
		Select år = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_LäggTillUtbildning_UtbildningPåGrundOchAvanceradNivåÅrFörExamen());
	...
	public void ExamensinriktningSelectSubjects() {
		...
		Select ämne1 = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_LäggTillUtbildning_Ämne1UtbildningPåGrundOchAvanceradNivå());
		Random randomOption = new Random();  
		int startOption = 1;
		...
		DriverWaitExpectedConditions.WaitForElementToBeClickable(driver, PortalLoggedInAsUserMinProfil.MinProfil_LäggTillUtbildning_Ämne2UtbildningPåGrundOchAvanceradNivå());
		Select ämne2 = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_LäggTillUtbildning_Ämne2UtbildningPåGrundOchAvanceradNivå());
		...
		DriverWaitExpectedConditions.WaitForElementToBeClickable(driver, PortalLoggedInAsUserMinProfil.MinProfil_LäggTillUtbildning_Ämne3UtbildningPåGrundOchAvanceradNivå());
		Select ämne3 = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_LäggTillUtbildning_Ämne3UtbildningPåGrundOchAvanceradNivå());
	...
	public void Examen() {
		...
		Select TypAvExamen = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_Utbildning_UtbildningPåGrundOchAvanceradNivåExamen());
		Random randomOption = new Random();  
		int startOption = 2;
	...
	public void Specialistkompetens() {
		...
		Select Specialistkompetens = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_Utbildning_UtbildningPåGrundOchAvanceradNivåSpecialistkompetens());
		Random randomOption = new Random();  
		int startOption = 1;
	...
	public void SpecialistkompetensÅr() {
		...
		Select SpecialistkompetensÅr = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_Utbildning_UtbildningPåGrundOchAvanceradNivåSpecialistkompetensÅR());
		Random randomOption = new Random();  
		int startOption = 1;
	...
	public void OmrådeBeskrivning() {
		...
		driver.findElement(PortalLoggedInAsUserMinProfil.MinProfil_Utbildning_UtbildningPåGrundOchAvanceradNivåOmrådeBeskrivning()).sendKeys("Test123");
	}
