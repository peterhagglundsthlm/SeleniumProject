...
public class LoginAsInvalidUser extends BeforeAfterTestBrowsers {
	...
	public void InputUserWithInvalidInfo() {
		...
		driver.findElement(SAT_Home_Page_Not_Logged_In.EnterUserName()).sendKeys("zfzfz");
		driver.findElement(SAT_Home_Page_Not_Logged_In.EnterPassword()).sendKeys("fsfbdbd");
