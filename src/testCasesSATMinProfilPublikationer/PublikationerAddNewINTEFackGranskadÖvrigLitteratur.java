...
public class PublikationerAddNewINTEFackGranskadÖvrigLitteratur extends BeforeAfterTestSetup {

	//TestCaseInfo = "Loggar in som en projektledare och lägger till en INTE fackgranskad Övrig Litteratur";
