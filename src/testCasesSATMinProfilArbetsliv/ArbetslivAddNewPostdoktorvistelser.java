...
public class ArbetslivAddNewPostdoktorvistelser extends BeforeAfterTestBrowsers {
	...
	public void AddPostdoktorvistelser() {
		...
		driver.findElement(PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserLäggTill()).click();
	}
	...
	public void SelectOrganization() throws InterruptedException {
		...
		driver.findElement(PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserSökOrganisation()).sendKeys(universitet);
	
		Thread.sleep(500);

		driver.findElement(PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserSökOrganisation()).sendKeys(Keys.DOWN);

		Thread.sleep(500);

		driver.findElement(PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserSökOrganisation()).sendKeys(Keys.ENTER);

		Thread.sleep(500);

		if (driver.getPageSource().contains("Postdoktorvistelser"))
		{
			driver.findElement(PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserSparaSöktOrganisation()).click();
		}
	...
	public void ÄmneDropDown() {
		...
		Select ämne1 = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserÄmne1());
		...
		Select ämne2 = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserÄmne2());
		...
		Select ämne3 = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserÄmne3());
	...
	public void PeriodStartOchSlutYear() {
		...
		Select PeriodStartYear = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserPeriodStartYear());
		Random randomOption = new Random();  
		int startOption = 1;
		...
		Select PeriodEndYear = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserPeriodEndYear());
	...
	public void PeriodStartMonth() {
		...
		Select PeriodStartMonth = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserPeriodStartMonth());
		Random randomOption = new Random();  
	...
	public void PeriodEndMonth() {
		...
		Select PeriodEndMonth = driverSelect.DropDown(driver, PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserPeriodEndMonth());
		Random randomOption = new Random();  
	...
	public void SparaPostdoktorvistelser() {
		...
		driver.findElement(PortalLoggedInAsUserMinProfil.MinProfil_Arbetsliv_PostdoktorvistelserSpara()).click();
	}
}