...
public class anliEpmForm09EjSambandFlerHuvudman extends anliEpmFormTitle01{

	@Test (dependsOnMethods={"BytFokusTillFormulär"})
	// Ansökan endast personuppgifter, en forskningshuvudman
	public void s1a9_AnsökanFleraFohuvEjSambandEjPersuppg() {
...

		{
			...
			wait2.until(ExpectedConditions.elementToBeClickable(By.id(EPM_applicationForm.BefintligaPersuppgFler)));
			Select PersUppg= new Select (driver.findElement(By.id(EPM_applicationForm.BefintligaPersuppgFler)));
			PersUppg.selectByVisibleText("Nej");

			// ansökanskategori, spara val3
			WebDriverWait wait2b = new WebDriverWait(driver, 10);
			wait2b.until(ExpectedConditions.elementToBeClickable(By.id(EPM_applicationForm.AnsökanskategoriSparaVal3)));
			driver.findElement(By.id(EPM_applicationForm.AnsökanskategoriSparaVal3)).click();
	...
	@Test (dependsOnMethods={"s1a9_AnsökanFleraFohuvEjSambandEjPersuppg"})
