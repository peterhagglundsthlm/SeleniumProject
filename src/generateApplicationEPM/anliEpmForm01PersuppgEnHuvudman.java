...
public class anliEpmForm01PersuppgEnHuvudman extends anliEpmFormTitle01 {
	...
	public void s1a_AnsökanEndastPersonuppgifter() throws InterruptedException {
		...
		generateApplicationEPM.anliEpmFormStandard.s1b_InfoSökande(driver);
		generateApplicationEPM.anliEpmFormStandard.s3_SyfteFrågeställningar(driver);
		generateApplicationEPM.anliEpmFormStandard.s4_Metod(driver);
		
		System.out.println("Nu ska 1a, 1b, 3 och 4 vara ifyllda.");
	}
...
//	}
//
//	@Test (dependsOnMethods={"standardApplication"})
