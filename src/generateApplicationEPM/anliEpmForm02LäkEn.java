...
public class anliEpmForm02LäkEn extends anliEpmFormTitle01{
	...
	public void s1a2_AnsökanEnFohuvLäk() {
...

		{
			...
			wait2b.until(ExpectedConditions.elementToBeClickable(By.id(EPM_applicationForm.AnsökanskategoriSparaVal)));
			driver.findElement(By.id(EPM_applicationForm.AnsökanskategoriSparaVal)).click();
