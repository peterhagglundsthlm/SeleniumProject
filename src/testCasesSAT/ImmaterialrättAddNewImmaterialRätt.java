...
public class ImmaterialrättAddNewImmaterialRätt extends BeforeAfterTestBrowsers {
	...
	public void LäggTill() {
		...
		PortalLoggedInAsUserMinProfil.MinProfil_ImmaterialrättLäggTill_Css(driver).click();
	}
	
	@Test (dependsOnMethods={"LäggTill"})
	public void Typ() {

		Select Typ = new Select (driver.findElement(By.id(PortalLoggedInAsUserMinProfil.MinProfil_ImmaterialrättTyp_Id)));
	...
	public void Id() {
		...
		PortalLoggedInAsUserMinProfil.MinProfil_ImmaterialrättId_Id(driver).sendKeys("123456");
	}
	
	@Test (dependsOnMethods={"Id"})
	public void DatumFörBeviljande() {

		PortalLoggedInAsUserMinProfil.MinProfil_ImmaterialrättDatumFörBeviljande_Name(driver).sendKeys("2018-05-09");
	}
	
	@Test (dependsOnMethods={"DatumFörBeviljande"})
	public void ProduktKlassificering() {

		Select ProduktKlassificering1 = new Select (driver.findElement(By.name(PortalLoggedInAsUserMinProfil.MinProfil_ImmaterialrättProduktKlassificering1_Name)));
		...
		Select ProduktKlassificering2 = new Select (driver.findElement(By.name(PortalLoggedInAsUserMinProfil.MinProfil_ImmaterialrättProduktKlassificering2_Name)));
	...
	public void LicensieradTillAnnan() {
		...
		Select LicensieradTillAnnan = new Select (driver.findElement(By.id(PortalLoggedInAsUserMinProfil.MinProfil_ImmaterialrättLicensieradTillAnnan_Id)));
	...
	public void LicensieradTillAnnanDropDown() {
		...
		Select LicensieradTillAnnanDropDown = new Select (driver.findElement(By.name(PortalLoggedInAsUserMinProfil.MinProfil_ImmaterialrättLicensieradTillAnnanDropwDown_Id)));
	...
	public void Spara() {
		...
		PortalLoggedInAsUserMinProfil.MinProfil_ImmaterialrättSpara_Id(driver).click();
	}
}